...
/* Date de cr�ation :  11/03/2022 12:13:28                      */
/*==============================================================*/
...
INSERT INTO achat (id_achat, id_utl, id_four, id_art, date, Quantite,Prix_unitaire, Prix_total)
        VALUES 
        ('7','3','5','1','2021/10/01','200','15','3000'),
        ('71','31','51','11','2021/12/05','25','1000','25000'),
        ('72','32','52','12','2022/01/15','100','500','50000'),
        ('73','33','53','13','2022/02/20','500','500','250000'),
        ('74','34','54','14','2022/03/01','1000','50','50000');
INSERT INTO vente (id_vent, id_utl, id_clt, id_art, date, Quantite,Prix_unitaire, Prix_total)
        VALUES 
        ('8','3','4','1','2019/10/01','200','15','3000'),
        ('81','31','41','11','2020/12/05','25','1000','25000'),
        ('82','32','42','12','2020/01/15','100','500','50000'),
        ('83','33','43','13','2021/02/20','500','500','250000'),
        ('84','34','44','14','2022/03/01','1000','50','50000');
